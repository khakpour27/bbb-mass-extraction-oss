...
Skripten er laget til å kjøre på ArcGIS Pro sin default pythonmiljø `arcgispro-py3`. Denne finner du på maskiner der ArcGIS Pro er installert under filstien `C:\Program Files\ArcGIS\Pro\bin\Python\envs\arcgispro-py3\python.exe`
